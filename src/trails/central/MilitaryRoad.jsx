...
import badgePlaceholder from "../../assets/images/badge-oldmilitaryroad.webp";
import trailheadStatic from "../../assets/images/map-centr-militaryroad.png";
import trailheadHero from "../../assets/images/Military-Road.webp";
// 📝 Photo credit (for internal records only):
// Hero image: courtesy of Tim Dachtera via Wikimedia Commons (CC Attribution 2.0 Generic)
...
const trailData = [
  ...
  { label: "Trail Distance", value: "3.5 miles (one way)" },
  { label: "Estimated Hike Duration", value: "2 – 2.5 hours (one way)" },
...
export default function MilitaryRoad() {
  const addressLink =
    "https://www.google.com/maps?q=Savanna+Portage+State+Park,+55626+Lake+Place,+McGregor,+MN+55760";
  const addressText =
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Savanna Portage State Park forest and wetlands along the Old Military Road Trail"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Walk Through History and Wilderness
            </h3>
                         <p className="text-lg text-gray-700 leading-relaxed">
  Photo of dock at Savanna Portage State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Savanna_Portage_State_Park.jpg"
    target="_blank"
    rel="noopener noreferrer"
    className="underline text-blue-700 hover:text-blue-900"
  >
    Tim Dachtera via Wikimedia Commons
  </a>
  {" "}(
  <a
  ...
  >
    CC Attribution 2.0 Generic
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
             The Old Military Road Trail follows a route carved out
              in the 1800s to connect Lake Superior with the Mississippi River.</p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Today, it winds through quiet forests, wetlands, and glacial
              ridges in one of Minnesota’s most remote state parks.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Expect a mix of boardwalks, dirt paths, and forest
              terrain with occasional historical markers and interpretive signs.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Ideal for those seeking solitude, birdwatching, and a
              sense of deep connection with Minnesota’s natural and cultural
              past.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>
                <strong>Trail Surface:</strong> Natural dirt and boardwalk sections
              </li>
              <li>
                <strong>Restrooms:</strong> Vault toilets near trailhead and Savanna Campground (seasonal)
              </li>
              <li>
                <strong>Camping:</strong> Modern campground and remote sites available
              </li>
              <li>
                <strong>Kid Friendly?</strong> Moderate — best for older kids and teens due to length
              </li>
              <li>
                <strong>Pet Policy:</strong> Pets on leash
              </li>
              <li>
                <strong>Parking:</strong> Trailhead lot off Hwy 210 near park office
              </li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Old Military Road Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Savanna Portage State Park"
                    loading="lazy"
