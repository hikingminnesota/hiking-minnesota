...
import badgePlaceholder from "../../assets/images/badge-glaciallakes.webp";
import trailheadStatic from "../../assets/images/map-centr-kettlelake.png";
import trailheadHero from "../../assets/images/Glacial-Lakes.webp";
// 📝 Photo credit (for internal records only):
// Hero image: courtesy of McGhiever via Wikimedia Commons (CC BY-SA 3.0 Unported)
...
const trailData = [
  ...
  { label: "Trail Distance", value: "2.8 miles (loop)" },
  { label: "Estimated Hike Duration", value: "1 – 1.5 hours" },
  { label: "Elevation Gain", value: "Around 120 feet" },
...
export default function KettleLake() {
  const addressLink =
    "https://www.google.com/maps?q=Glacial+Lakes+State+Park,+25022+County+Rd+41,+Starbuck,+MN+56381";
  const addressText =
    "Glacial Lakes State Park — Kettle Lake Trail, 25022 County Rd 41, Starbuck, MN 56381";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Prairie and kettle lakes at Glacial Lakes State Park"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Glacial Landscapes and Prairie Serenity
            </h3>
              <p className="text-lg text-gray-700 leading-relaxed">
              Photo of Council Ring at Glacial Lakes State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Council_Ring_at_Glacial_Lakes_State_Park,_Minnesota_(38054821565).jpg"
    target="_blank"
  ...
  >
    CC BY-Share Alike 2.0 Generic
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Kettle Lake Trail explores classic glacial
              landforms, including kames, eskers, and kettle depressions formed
              by melting ice sheets thousands of years ago.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Expect rolling prairie, oak savanna, and shimmering
              lakes surrounded by gentle hills. </p>
          <p className="text-lg text-gray-700 leading-relaxed">
              This peaceful setting is ideal
              for birdwatching, photography, and quiet reflection.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              The park’s terrain showcases the transition from prairie
              to forest, offering hikers a chance to experience Minnesota’s
              ancient glacial history firsthand.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>
                <strong>Trail Surface:</strong> Grass and dirt
              </li>
              <li>
                <strong>Restrooms:</strong> Vault toilets near trailhead and campground (seasonal)
              </li>
              <li>
              ...
              <li>
                <strong>Parking:</strong> Main lot by Kettle Lake Trailhead off County Road 41
              </li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Kettle Lake Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Glacial Lakes State Park"
                    loading="lazy"
