...
import badgePlaceholder from "../../assets/images/badge-lakemaria.webp";
import trailheadStatic from "../../assets/images/map-centr-lakemaria.png";
import trailheadHero from "../../assets/images/Lake-Maria.webp";
// 📝 Photo credit (for internal records only):
// Hero image: courtesy of Vasanth Rajkumar via Wikimedia Commons (CC BY-SA 3.0)
...
const trailData = [
  ...
  { label: "Trail Distance", value: "5.0 miles (network of loop and spur trails)" },
  { label: "Estimated Hike Duration", value: "2 – 3 hours" },
  { label: "Elevation Gain", value: "Around 180 feet" },
  { label: "Best Season To Visit", value: "Late spring or fall, summer can be a challenge" },
];
...
export default function LakeMaria() {
  const addressLink =
    "https://www.google.com/maps?q=Lake+Maria+State+Park,+11411+Clementa+Ave+NW,+Monticello,+MN+55362";
  const addressText =
    "Lake Maria State Park — Hiking Trails, 11411 Clementa Ave NW, Monticello, MN 55362";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Lake Maria State Park forest trail and lakeshore in autumn"
  ...
  Photo above of autumn road at Lake Maria State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Lake_Maria_State_Park.JPG"
    target="_blank"
    rel="noopener noreferrer"
    className="underline text-blue-700 hover:text-blue-900"
  >
    Vasanth Rajkumar via Wikimedia Commons
  </a>
  {" "}(
  <a
  ...
  >
    CC BY-SA 3.0 Unported
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Lake Maria’s network of trails winds through dense
              Big Woods forest and around a trio of quiet glacial lakes. The
              terrain varies from rolling hills to wetlands, with plenty of
              shade and solitude.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              This park is known for its primitive camping and
              backcountry feel despite being close to the Twin Cities. Expect
              narrow, natural-surface paths ideal for hiking and snowshoeing.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Horseflies can be a factor in midsummer; spring and
              fall provide the most comfortable hiking conditions.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>
                <strong>Trail Surface:</strong> Natural dirt and grass
              </li>
              <li>
                <strong>Restrooms:</strong> Vault toilets near parking and trailheads (seasonal)
              </li>
              <li>
                <strong>Camping:</strong> Backpack-only sites
              </li>
              <li>
                <strong>Kid Friendly?</strong> Moderate - best for older children and teens due to length
              </li>
              <li>
                <strong>Pet Policy:</strong> Pets on leash
              </li>
              <li>
                <strong>Parking:</strong> Main lot off Clementa Ave NW near trail center
              </li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Lake Maria State Park"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Lake Maria State Park"
                    loading="lazy"
