...
import badgePlaceholder from "../../assets/images/badge-lakecarlos.webp";
import trailheadStatic from "../../assets/images/map-centr-lakecarlos.png";
import trailheadHero from "../../assets/images/LakeCarlos.webp";
// 📝 Photo credit (for internal records only):
// Hero image: courtesy of McGhiever via Wikimedia Commons (CC BY-SA 3.0)
...
const trailData = [
  ...
  { label: "Trail Distance", value: "2.9 miles (loop)" },
...
export default function LakeCarlos() {
  const addressLink =
    "https://www.google.com/maps?q=Lake+Carlos+State+Park,+2601+County+Rd+38+NE,+Carlos,+MN+56319";
  const addressText =
    "Lake Carlos State Park — Hiking Club Trail, 2601 County Rd 38 NE, Carlos, MN 56319";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Lakeside trail at Lake Carlos State Park"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Rolling Hills and Lakeside Forest
            </h3>
             <p className="text-lg text-gray-700 leading-relaxed">
  Photo above of Lake Carlos State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:LakeCarlosStatePark.jpg"
    target="_blank"
  ...
  >
    CC BY-SA 3.0
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Hiking Club Trail at Lake Carlos State Park winds
              through a variety of terrain including wooded ridges, wetlands,
              and open hills overlooking Lake Carlos.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Along the route, you’ll encounter boardwalks, gentle
              climbs, and several scenic lake overlooks that make this trail one
              of Central Minnesota’s most beautiful park hikes.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              In summer, expect songbirds and wildflowers. In autumn,
              the forest bursts into brilliant shades of gold and orange.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>
                <strong>Restrooms:</strong> Modern restrooms near beach area and campground
              </li>
              <li>
                <strong>Camping:</strong> Modern and rustic campsites available
              </li>
              <li>
                <strong>Kid Friendly?</strong> Yes — moderate length but gentle terrain
              </li>
              <li>
                <strong>Pet Policy:</strong> Pets on leash
              </li>
              <li>
                <strong>Parking:</strong> Main lot near beach and trailhead
              </li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Lake Carlos State Park"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Lake Carlos State Park"
                    loading="lazy"
