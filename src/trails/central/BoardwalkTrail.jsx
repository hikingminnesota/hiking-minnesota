...
import badgePlaceholder from "../../assets/images/badge-boardwalktrail.webp";
import trailheadStatic from "../../assets/images/map-centr-boardwalktrail.png";
import trailheadHero from "../../assets/images/Boardwalk-Trail.webp";
...
const trailData = [
  ...
  { label: "Difficulty", value: "Easy (Accessible Boardwalk)" },
  { label: "Trail Distance", value: "0.6 mile loop" },
  { label: "Estimated Hike Duration", value: "20 – 30 minutes" },
  { label: "Elevation Gain", value: "Negligible (less than 20 feet)" },
...
export default function BoardwalkTrail() {
  const addressLink =
    "https://www.google.com/maps?q=Lake+Bemidji+State+Park,+3401+State+Park+Rd+NE,+Bemidji,+MN+56601";
  const addressText =
    "Lake Bemidji State Park — Boardwalk Trail, 3401 State Park Rd NE, Bemidji, MN 56601";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Accessible boardwalk through tamarack bog at Lake Bemidji State Park"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Explore the Tamarack Bog
            </h3>
                        <p className="text-lg text-gray-700 leading-relaxed">
  Photo above of sign for Lake Bemidji State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Lake_Bemidji_State_Park_Sign,_Minnesota_(35222023325).jpg"
    target="_blank"
  ...
  >
    CC BY-Share Alike 2.0 Generic
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              A fully accessible boardwalk that winds through Lake Bemidji State Park’s tamarack bog, showcasing unique wetland plants, wildflowers, and songbirds.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Interpretive signs offer insight into the delicate bog ecosystem and how these wetlands support rare flora and fauna.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              A short, peaceful walk ideal for families, photographers, and visitors seeking quiet immersion in nature.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Trail Surface:</strong> Wood boardwalk (plank)</li>
              <li><strong>Restrooms:</strong> Near visitor center</li>
              <li><strong>Camping:</strong> Modern and electric sites available</li>
              <li><strong>Kid Friendly?</strong> Yes — fully accessible</li>
              <li><strong>Pet Policy:</strong> Pets on leash</li>
              <li><strong>Parking:</strong> Visitor lot</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Lake Bemidji Boardwalk Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Lake Bemidji Boardwalk Trail"
                    loading="lazy"
