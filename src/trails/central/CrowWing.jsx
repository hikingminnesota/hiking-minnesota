...
import badgePlaceholder from "../../assets/images/badge-crowwing.webp";
import trailheadStatic from "../../assets/images/map-centr-crowwing.png";
import trailheadHero from "../../assets/images/Crow-Wing.webp";
...
const trailData = [
  ...
  { label: "Elevation Gain", value: "Around 60 ft" },
...
export default function CrowWing() {
  const addressLink =
    "https://www.google.com/maps?q=Crow+Wing+State+Park,+3124+State+Park+Rd,+Brainerd,+MN+56401";
  const addressText =
    "Crow Wing State Park — Old Wadena Trail, 3124 State Park Rd, Brainerd, MN 56401";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Crow Wing and Mississippi Rivers confluence at Crow Wing State Park"
  ...
  Photo above of Crow Wing State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Old_Crow_Wing.JPG"
    target="_blank"
  ...
  >
    CC BY-Share Alike 3.0 Unported
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Old Wadena Trail explores the historic site of the
              town of Old Crow Wing, once a bustling trading post where the Crow
              Wing and Mississippi Rivers meet. Today, the trail winds through
              peaceful woods and along the water’s edge.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Interpretive signs along the trail tell stories of the
              Dakota and Ojibwe people, early fur traders, and settlers who
              shaped the region. The walk offers a quiet connection to Minnesota’s
              frontier past.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              A gentle, family-friendly trail with minimal elevation
              gain and plenty of shade, making it ideal for a relaxing hike or a
              peaceful picnic stop.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>
                <strong>Restrooms:</strong> Near visitor area
              </li>
              <li>
              ...
              <li>
                <strong>Parking:</strong> At visitor lot
              </li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Crow Wing State Park"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Crow Wing State Park"
                    loading="lazy"
