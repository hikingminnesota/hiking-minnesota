...
import badgePlaceholder from "../../assets/images/badge-inspirationpeak.webp";
import trailheadStatic from "../../assets/images/map-centr-inspirationpeak.png";
import trailheadHero from "../../assets/images/Inspiration-Peak.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "0.4 mile (round trip)" },
  { label: "Estimated Hike Duration", value: "20 – 25 minutes" },
...
export default function InspirationPeak() {
  const addressLink =
    "https://www.google.com/maps?q=Inspiration+Peak+State+Wayside,+43749+120th+Street,+Clitherall,+MN,+56524";
  const addressText =
    "Inspiration Peak State Wayside Park — Summit Trail, 43749 120th Street, Clitherall, MN 56524";
  const feesText = "No state park permit required (state wayside)";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Summit overlook at Inspiration Peak with prairie and lake views"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              ...
              Photo of Inspiration Peak walking path is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Inspiration_Peak_Path.jpg"
    target="_blank"
    rel="noopener noreferrer"
    className="underline text-blue-700 hover:text-blue-900"
  >
    Amanda Su via Wikimedia Commons
  </a>
  {" "}(
  <a
    ...
    className="underline text-blue-700 hover:text-blue-900"
  >
    CC BY-Share Alike 4.0 International
  </a>
  ).
</p>
            <p className="text-lg text-gray-700 leading-relaxed">
              A relatively short but steep climb leads to one of the
              highest viewpoints in West Central Minnesota, where sweeping prairie
              and lake vistas stretch to the horizon.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Expect natural-surface footing and a quick elevation
              gain to the summit overlook, with benches for catching your breath
              and soaking in the scenery.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Sunset and fall colors are especially stunning from the
              top, making this a must-do stop when exploring the Central region.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>
                <strong>Trail Surface:</strong> Dirt and gravel
              </li>
              <li>
                <strong>Restrooms:</strong> Vault toilet near parking area (seasonal)
              </li>
              <li>
                <strong>Camping:</strong> None (wayside area)
              </li>
              <li>
                <strong>Kid Friendly?</strong> Older teens ok; children may be frustrated by the steep climb with uneven pavement.
              </li>
              <li>
                <strong>Pet Policy:</strong> Pets on leash
              </li>
              <li>
                <strong>Parking:</strong> Small lot at base of trail
              </li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Inspiration Peak"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Inspiration Peak State Wayside"
                    loading="lazy"
