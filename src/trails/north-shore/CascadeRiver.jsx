...
import badgePlaceholder from "../../assets/images/badge-lookoutmountain.webp";
import trailheadStatic from "../../assets/images/map-norsh-cascaderiver.png";
import trailheadHero from "../../assets/images/Cascade-River-State-Park-Lookout-James-B-Bleeker.webp";
// 📝 Photo credit (for internal records only):
// Hero image: “Cascade River State Park Lookout” — Photo by James B. Bleeker via Wikimedia Commons (CC BY-SA 3.0)
...
const trailData = [
  ...
  { label: "Trail Distance", value: "3.5 miles (loop)" },
  { label: "Estimated Hike Duration", value: "2 - 2.5 hours" },
  { label: "Elevation Gain", value: "Around 600 feet" },
...
export default function CascadeRiver() {
  const addressLink =
    "https://www.google.com/maps?q=Cascade+River+State+Park,+3481+W+Highway+61,+Lutsen,+MN+55612";
  const addressText =
    "Cascade River State Park — Lookout Mountain Trail, 3481 W Highway 61, Lutsen, MN 55612";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img src={trailheadHero}
          alt="Cascade River waterfalls and Lookout Mountain overlook"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Waterfalls, Forests, and a Panoramic Summit
            </h3>
                  <p className="text-lg text-gray-700 leading-relaxed">
              Photo of a lookout at Cascade River State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Cascade_River_State_Park_Lookout.jpg"
    target="_blank"
    rel="noopener noreferrer"
    className="underline text-blue-700 hover:text-blue-900"
  >
    James B. Bleeker via Wikimedia Commons
  </a>
  {" "}(
  <a
  ...
  >
    Share Alike 3.0 Unported
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              This trail ascends from the banks of the Cascade River
              to Lookout Mountain, rewarding hikers with sweeping views of Lake
              Superior and the Sawtooth Mountains.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Along the way, multiple waterfalls tumble through deep
              gorges, surrounded by birch, cedar, and pine. The climb is steady
              but achievable for most hikers.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              A classic North Shore hike that combines elevation,
              scenery, and tranquility in one unforgettable loop.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>
                <strong>Trail Surface:</strong> Packed dirt and rocky sections; well-marked forest path
              </li>
              <li>
                <strong>Restrooms:</strong> Available at the trailhead near the main parking lot
              </li>
              <li>
                <strong>Camping:</strong> Yes — Cascade River State Park Campground (tent, RV, and group sites)
              </li>
              <li>
                <strong>Kid Friendly?</strong> Older teens fine, younger children will be frustrated with steep climbs.
              </li>
              <li>
                <strong>Pet Policy:</strong> Pets allowed on leash
              </li>
              <li>
                <strong>Parking:</strong> Large paved lot near the visitor center and trailhead
              </li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Lookout Mountain Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Cascade River State Park"
                    loading="lazy"
