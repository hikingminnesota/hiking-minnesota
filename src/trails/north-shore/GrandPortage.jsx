...
import badgePlaceholder from "../../assets/images/badge-pigeonriver.webp";
import trailheadStatic from "../../assets/images/map-norsh-grandportage.png";
import trailheadHero from "../../assets/images/Grand-Portage-Tony-Webster.webp";
// 📝 Photo credit (for internal records only):
// Hero image: Photo by Tony Webster via Wikimedia Commons (CC BY-SA 2.0 Generic) -- we credit McGhiever in the text below
...
const trailData = [
  ...
  { label: "Trail Distance", value: "0.6 miles (one way)" },
  { label: "Estimated Hike Duration", value: "30 minutes round trip (allow extra time for viewpoints)" },
  { label: "Elevation Gain", value: "About 60 ft — gentle forest climb to the 120-ft High Falls overlook" },
...
export default function GrandPortage() {
  const addressLink =
    "https://www.google.com/maps?q=Grand+Portage+State+Park,+9393+E+Highway+61,+Grand+Portage,+MN+55605";
  const addressText =
    "Grand Portage State Park — High Falls Trail, 9393 E Highway 61, Grand Portage, MN 55605";
  const feesText = "No state park entry fee (jointly managed with Grand Portage Band)";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="High Falls at Grand Portage State Park on the Pigeon River"
  ...
  Photo above of boardwalk at Grand Portage State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Grand_Portage_State_Park_High_Falls_Boardwalk_-_Northern_Minnesota_(37085760274).jpg"
    target="_blank"
  ...
  >
    CC Share Alike 2.0 Generic
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              This short, paved trail leads to the breathtaking High
              Falls of the Pigeon River, Minnesota’s tallest waterfall at over
              120 feet. The path is fully accessible and offers multiple
              overlook decks with dramatic views.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Interpretive signs along the way share Ojibwe cultural
              history, local wildlife, and the story of the Grand Portage trail
              that once linked fur traders to Lake Superior.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              This hike is ideal for families, photographers, and anyone seeking
              one of Minnesota’s most impressive natural landmarks.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>
                <strong>Trail Surface:</strong> Paved and boardwalk
              </li>
              <li>
                <strong>Restrooms:</strong> Modern facilities at visitor center
              </li>
              <li>
                <strong>Camping:</strong> Not available in park; there are nearby sites at marina or state forest
              </li>
              <li>
                <strong>Kid Friendly?</strong> Yes — accessible and short
              </li>
              <li>
                <strong>Pet Policy:</strong> Pets allowed on 6-ft leash
              </li>
              <li>
                <strong>Parking:</strong> Large paved lot near visitor center
              </li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Grand Portage High Falls Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Grand Portage State Park"
                    loading="lazy"
