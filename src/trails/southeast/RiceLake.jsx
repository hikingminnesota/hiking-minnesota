...
import badgePlaceholder from "../../assets/images/badge-ricelake.webp";
import trailheadStatic from "../../assets/images/map-seast-ricelake.png";
import trailheadHero from "../../assets/images/Rice-Lake.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "2.1 miles (loop)" },
  { label: "Estimated Hike Duration", value: "1 - 1.5 hours" },
  { label: "Elevation Gain", value: "Around 75 ft (gentle, flat terrain)" },
  { label: "Best Season To Visit", value: "Spring and fall (migratory birds)" },
];
...
export default function RiceLake() {
  const addressLink =
    "https://www.google.com/maps?q=Rice+Lake+State+Park,+8485+Rose+Street,+Owatonna,+MN+55060";
  const addressText =
    "Rice Lake State Park — Lake Trail, 8485 Rose Street, Owatonna, MN 55060";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Rice Lake State Park - Lake Trail"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Peaceful Loops Around a Waterfowl Haven
            </h3>
                                                <p className="text-lg text-gray-700 leading-relaxed">
  Photo of Rice Lake is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:RiceLakeStateParkMN.jpg"
    target="_blank"
  ...
  >
    CC Attribution - Share Alike 2.5 Generic
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Lake Trail at Rice Lake State Park encircles a scenic lake 
              that serves as an important stopover for migrating waterfowl. 
              Expect peaceful views, gentle terrain, and plenty of wildlife 
              activity during spring and fall migration seasons.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              This easy route is perfect for birdwatchers, families, and 
              those looking for a relaxing walk surrounded by wetlands and 
              open prairie.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              In addition to the loop trail, the park offers picnic areas, 
              canoe access, and a sense of quiet seclusion — a true hidden gem 
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Trail Surface:</strong> Grass and dirt</li>
              <li><strong>Restrooms:</strong> Near parking area</li>
              <li><strong>Camping:</strong> Tent and camper sites available</li>
              <li><strong>Kid Friendly?</strong> Yes</li>
              <li><strong>Pet Policy:</strong> Pets on leash</li>
              <li><strong>Parking:</strong> Main lot near lake access</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Lake Trail at Rice Lake State Park"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Rice Lake State Park"
                    loading="lazy"
