...
import badgePlaceholder from "../../assets/images/badge-mysterycave.webp";
import trailheadStatic from "../../assets/images/map-seast-mysterycave.png";
import trailheadHero from "../../assets/images/Mystery-Cave.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "2.0 miles (loop)" },
  { label: "Estimated Hike Duration", value: "1 - 1.5 hours" },
  { label: "Elevation Gain", value: "Around 150 ft (gentle rolling hills)" },
...
export default function MysteryCave() {
  const addressLink =
    "https://www.google.com/maps?q=Forestville%2FMystery+Cave+State+Park%2C+21071+County+Rd+118%2C+Preston%2C+MN+55965";
  const addressText =
    "Forestville/Mystery Cave State Park — Historic Forestville Trail, 21071 County Rd 118, Preston, MN 55965";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Forestville/Mystery Cave State Park - Historic Forestville Trail"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Where History Meets Geology
            </h3>
                                    <p className="text-lg text-gray-700 leading-relaxed">
  Photo of Mystery Cave is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Mystery_Cave_Turquoise_Lake.jpg"
    target="_blank"
  ...
  >
    CC Attribution - Share Alike 4.0 International
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Historic Forestville Trail blends natural beauty with a glimpse into 19th-century life.</p> 
            <p className="text-lg text-gray-700 leading-relaxed">
              Begin near the restored townsite and follow the trail through oak forest and along the scenic Root River.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Visitors can explore the remnants of the old settlement, discover limestone outcrops, and connect to the state’s only publicly accessible cave system: Mystery Cave.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Above ground or below, this park offers a rare combination of nature, geology, and Minnesota history in one unforgettable hike.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Restrooms:</strong> Visitor center and picnic area</li>
              <li><strong>Camping:</strong> Modern and equestrian sites available</li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Historic Forestville Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Historic Forestville Trail"
                    loading="lazy"
