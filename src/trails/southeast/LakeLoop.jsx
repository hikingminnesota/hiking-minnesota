...
import badgePlaceholder from "../../assets/images/badge-lakeloop.webp";
import trailheadStatic from "../../assets/images/map-seast-lakeloop.png";
import trailheadHero from "../../assets/images/Lake-Louise.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "1.8 miles (loop)" },
  { label: "Estimated Hike Duration", value: "45 minutes - 1 hour" },
  { label: "Elevation Gain", value: "Minimal" },
  { label: "Best Season To Visit", value: "Summer and early fall" },
];
...
export default function LakeLoop() {
  const addressLink =
    "https://www.google.com/maps?q=Lake+Louise+State+Park,+12385+766th+Avenue,+Le+Roy,+MN+55951";
  const addressText =
    "Lake Louise State Park — 12385 766th Avenue, Le Roy, MN 55951";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Lake Louise State Park - Lake Loop Trail"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Peaceful Loops Around the Lake
            </h3>
            <p className="text-lg text-gray-700 leading-relaxed">
            Photo of kayakers on Lake Louise is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Lake_Louise_State_Park.jpg"
    target="_blank"
  ...
  >
    CC Attribution - Share Alike 3.0 Unported
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Lake Loop Trail gently circles Lake Louise, offering
              serene lakeside views and a calm hiking experience for visitors
              seeking quiet, natural beauty.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              This easy trail is perfect for families, beginners, and
              birdwatchers.</p>
            <p className="text-lg text-gray-700 leading-relaxed">
               Expect open prairies, forest edges, and occasional
              glimpses of wildlife.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              With minimal elevation and scenic resting areas, it’s a
              great destination for a slow-paced afternoon surrounded by nature.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Restrooms:</strong> Near campground</li>
              <li><strong>Camping:</strong> Modern and equestrian sites</li>
              <li><strong>Kid Friendly?</strong> Yes</li>
              <li><strong>Pet Policy:</strong> Pets on leash</li>
              <li><strong>Parking:</strong> Near picnic area</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Lake Loop Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Lake Loop Trail"
                    loading="lazy"
