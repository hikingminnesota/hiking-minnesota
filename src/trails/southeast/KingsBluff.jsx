...
import badgePlaceholder from "../../assets/images/badge-kingsbluff.webp";
import trailheadStatic from "../../assets/images/map-seast-kingsbluff.png";
import trailheadHero from "../../assets/images/Kings-Bluff.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "2.5 miles (loop)" },
  { label: "Estimated Hike Duration", value: "1.5 - 2 hours" },
  { label: "Elevation Gain", value: "Around 350 feet - bluff ascent" },
  { label: "Best Season To Visit", value: "Fall for peak foliage views" },
];
...
export default function KingsBluff() {
  const addressLink =
    "https://www.google.com/maps?q=Great+River+Bluffs+State+Park,+43605+Kipp+Drive,+Winona,+MN+55987";
  const addressText =
    "Great River Bluffs State Park — King’s Bluff Trail, 43605 Kipp Drive, Winona, MN 55987";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="View from King's Bluff overlooking the Mississippi River Valley at Great River Bluffs State Park"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Soaring Views Over the Mississippi River
            </h3>
                                    <p className="text-lg text-gray-700 leading-relaxed">
  Photo of east overlook of Mississippi River is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Great_River_Bluffs_State_Park_east_overlook.JPG"
    target="_blank"
  ...
  >
    CC Attribution - Share Alike 3.0 Unported
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The King’s Bluff Trail is the crown jewel of Great
              River Bluffs State Park. </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              It winds through oak savanna and prairie
              before arriving at a breathtaking overlook high above the
              Mississippi River Valley.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              From the viewing deck, you can see the peaceful river winding
              through the bluffs, and the vast landscape stretching for miles.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              This moderate hike rewards every step of the climb with
              unmatched scenery. Autumn is especially spectacular here as the
              hardwoods ignite in color.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Camping:</strong> Modern sites and group camps available</li>
              ...
              <li><strong>Parking:</strong> Main overlook lot</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for King's Bluff Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for King's Bluff Trail"
                    loading="lazy"
