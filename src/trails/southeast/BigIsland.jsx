...
import badgePlaceholder from "../../assets/images/badge-bigisland.webp";
import trailheadStatic from "../../assets/images/map-seast-bigisland.png";
import trailheadHero from "../../assets/images/Big-Island.webp";
...
export default function BigIsland() {
  const addressLink =
    "https://www.google.com/maps?q=Myre+-+Big+Island+State+Park,+19499+790th+Ave,+Albert+Lea,+MN+56007";
  const addressText =
    "Myre – Big Island State Park — Big Island Loop, 19499 790th Avenue, Albert Lea, MN 56007-7022";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Trail view on Big Island surrounded by trees and lake"
  ...
  Photo of Myra / Big Island State Park entrance is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Myre-BigIslandStatePark2007sign.JPG"
    target="_blank"
  ...
  >
    CC Attribution - Share Alike 3.0 Unported
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Big Island Loop circles the park’s namesake island, with 
              shaded forest paths, serene lake views, and abundant birdlife. The paved 
              and natural surfaces make it accessible and scenic year-round.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Expect sightings of deer, herons, and songbirds as you 
              follow the trail around Albert Lea Lake. Several benches and picnic 
              spots invite you to linger along the route.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              A family-friendly trail with both short loops and longer 
              extensions, perfect for casual walking, biking, or nature photography.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Trail Surface:</strong> Paved and natural dirt</li>
              ...
              <li><strong>Parking:</strong> Main island lot</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Myre - Big Island State Park"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Big Island Loop"
                    loading="lazy"
