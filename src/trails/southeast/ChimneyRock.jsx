...
import badgePlaceholder from "../../assets/images/badge-chimneyrock.webp";
import trailheadStatic from "../../assets/images/map-seast-chimneyrock.png";
import trailheadHero from "../../assets/images/Chimney-Rock.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "1.4 miles (round trip)" },
  { label: "Estimated Hike Duration", value: "45 minutes - 1 hour" },
  { label: "Elevation Gain", value: "Steep bluff climbs" },
...
export default function ChimneyRock() {
  const addressLink =
    "https://www.google.com/maps?q=Whitewater+State+Park,+19041+Highway+74,+Altura,+MN+55910";
  const addressText =
    "Whitewater State Park — Chimney Rock Trail, 19041 Highway 74, Altura, MN 55910";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Chimney Rock overlook at Whitewater State Park"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Bluffs, Valleys, and Views
            </h3>
  <p className="text-lg text-gray-700 leading-relaxed">
  Photo of overlook at Whitewater State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File%3AWhitewater_River_at_Whitewater_State_Park_-_Chimney_Rock_Trail_-_Minnesota_in_Spring_%2854182521193%29.jpg"
    target="_blank"
  ...
  >
    CC Attribution - Share Alike 2.0 Generic
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Chimney Rock Trail climbs the steep bluffs of
              Whitewater State Park, rewarding hikers with panoramic views of
              the Whitewater River Valley and its distinctive limestone
              formations.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Along the way, interpretive signs describe the park’s
              glacial and geological history, highlighting how the unique
              landscape was carved over thousands of years.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Expect some very challenging uphill sections but also some
              of the most iconic scenic overlooks in all of southern Minnesota.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Trail Surface:</strong> Dirt and limestone</li>
              <li><strong>Restrooms:</strong> Near trailhead and picnic area</li>
              <li><strong>Camping:</strong> Modern sites and group camp nearby</li>
              <li><strong>Kid Friendly?</strong> Only for older teens; there are steep drop-offs.</li>
              <li><strong>Pet Policy:</strong> Pets on leash</li>
              <li><strong>Parking:</strong> Chimney Rock trailhead lot</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Chimney Rock Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Chimney Rock Trail"
                    loading="lazy"
