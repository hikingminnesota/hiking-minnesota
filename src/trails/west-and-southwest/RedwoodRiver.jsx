...
import badgePlaceholder from "../../assets/images/badge-redwoodriver.webp";
import trailheadStatic from "../../assets/images/map-swest-redwoodriver.png";
import trailheadHero from "../../assets/images/Redwood-River.webp";
// 📝 Photo credit (for internal records only):
// Hero image: courtesy of Tim Kiser via Wikimedia Commons (CC BY-SA 2.5 Generic)
...
export default function RedwoodRiver() {
  const addressLink =
    "https://www.google.com/maps?q=1897+Camden+Park+Rd,+Lynd,+MN+56157";
  const addressText =
    "Camden State Park — Redwood River Trail, 1897 Camden Park Rd, Lynd, MN 56157";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Camden State Park - Redwood River Trail"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Peaceful Hike Along the Redwood River
            </h3>
            <p className="text-lg text-gray-700 leading-relaxed">
  Photo of Redwood River is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Redwood_River_Camden.jpg"
    target="_blank"
  ...
  >
    CC Attribution-Share Alike 2.5 Generic
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Redwood River Trail at Camden State Park meanders along the
              banks of the Redwood River, winding through shaded forest and
              scenic prairie. The terrain alternates between river valleys and
              gentle rolling hills, offering hikers a tranquil journey through
              one of Minnesota’s hidden gems.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Expect peaceful woodland paths, occasional wildlife sightings, and
              quiet riverside views. 
            </p>
              <p className="text-lg text-gray-700 leading-relaxed">
              This trail provides a perfect balance of
              accessibility and natural beauty, making it ideal for families or
              solo hikers seeking a relaxed outdoor escape.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Restrooms:</strong> Near main picnic area</li>
              ...
              <li><strong>Parking:</strong> Near Redwood River picnic shelter</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Camden State Park"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Camden State Park"
                    loading="lazy"
