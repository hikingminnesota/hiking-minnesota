...
import badgePlaceholder from "../../assets/images/badge-pipestonenationals.webp";
import trailheadStatic from "../../assets/images/map-swest-pipestonenational.png";
import trailheadHero from "../../assets/images/Pipestone-National.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "0.75-mile loop" },
...
export default function PipestoneNational() {
  const addressLink =
   "https://www.google.com/maps?q=36+Reservation+Avenue,+Pipestone,+MN,+56164";
  const addressText =
    "Pipestone National Monument — Circle Trail, 36 Reservation Avenue, Pipestone, MN 56164";
  const feesText = "No state park permit required (National Park Service site)";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Pipestone National Monument - Circle Trail"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Sacred Stone and Natural Beauty
            </h3>
                        <p className="text-lg text-gray-700 leading-relaxed">
  Photo of "See The Oracle" sign at Pipestone National Monument is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:See_the_Oracle_-_Pipestone_National_Monument_Minnesota_(37458161244).jpg"
    target="_blank"
  ...
  >
    CC Attribution - Share Alike 2.0 Generic
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Circle Trail at Pipestone National Monument offers a
              contemplative walk through one of Minnesota’s most culturally and
              historically important landscapes. For centuries, Indigenous
              peoples have quarried the soft red pipestone here to craft sacred
              ceremonial pipes.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              The paved loop passes the active quarries, interpretive signs, and
              Winnewissa Falls — a hidden gem surrounded by native prairie and
              towering quartzite cliffs. The trail blends natural beauty with
              cultural meaning, offering a profound sense of place.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              This short loop is ideal for all skill levels and can be enjoyed
              year-round. Please remember that the quarries remain an active and
              sacred site; visitors are encouraged to walk with respect.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Trail Surface:</strong> Paved loop</li>
              <li><strong>Restrooms:</strong> Visitor center</li>
              <li><strong>Camping:</strong> None on site</li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Pipestone National Monument"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Pipestone National Monument"
                    loading="lazy"
