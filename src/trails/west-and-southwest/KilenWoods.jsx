...
import badgePlaceholder from "../../assets/images/badge-kilenwoods.webp";
import trailheadStatic from "../../assets/images/map-swest-kilenwoods.png";
import trailheadHero from "../../assets/images/Kilen-Woods.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "2.5 miles round trip" },
  { label: "Estimated Hike Duration", value: "About 1 hour" },
  { label: "Elevation Gain", value: "Minimal to moderate along river bluffs" },
...
export default function KilenWoods() {
  const addressLink =
    "https://www.google.com/maps?q=50200+860th+Street,+Lakefield,+MN+56150";
  const addressText =
    "Kilen Woods State Park — Des Moines River Trail, 50200 860th Street, Lakefield, MN 56150";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Kilen Woods State Park - Des Moines River Trail"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Serene River Valley Hike
            </h3>
            <p className="text-lg text-gray-700 leading-relaxed">
  Photo of overlook at Kilen Woods State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Kilen_Woods_State_Park_overlook.JPG"
    target="_blank"
  ...
  >
    CC BY-SA 3.0 Unported
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Kilen Woods State Park offers quiet hiking trails that follow the
              Des Moines River, winding through wooded bluffs and open prairie.
              The Des Moines River Trail provides a blend of shade, scenic river
              overlooks, and peaceful solitude.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              This park is a hidden gem in southwestern Minnesota, far from the
              crowds — a perfect retreat for birdwatchers, photographers, and
              anyone seeking calm along the river.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Trails are well-marked and relatively easy, making Kilen Woods a
              great choice for families or casual hikers exploring the prairie
              river landscape.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Trail Surface:</strong> Dirt and grass paths</li>
              <li><strong>Restrooms:</strong> Near picnic area</li>
              <li><strong>Camping:</strong> Available within the park</li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Kilen Woods State Park"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Kilen Woods State Park"
                    loading="lazy"
