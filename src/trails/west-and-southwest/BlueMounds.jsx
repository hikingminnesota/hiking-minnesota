...
import badgePlaceholder from "../../assets/images/badge-bluemounds.webp";
import trailheadStatic from "../../assets/images/map-swest-bluemounds.png";
import trailheadHero from "../../assets/images/Blue-Mounds.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "3 miles round trip" },
  { label: "Estimated Hike Duration", value: "About 1 hour" },
  { label: "Elevation Gain", value: "Approx. 180 feet" },
...
export default function BlueMounds() {
  const addressLink =
    "https://www.google.com/maps?q=1410+161st+St,+Luverne,+MN+56156";
  const addressText =
    "Blue Mounds State Park — Mound Trail, 1410 161st St, Luverne, MN 56156";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Blue Mounds State Park - Mound Trail"
  ...
  Photo of WPA Dam at Blue Mound State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Blue_Mounds_State_Park_WPA_Dam.jpg"
    target="_blank"
  ...
  <a
    ...
    className="underline text-blue-700 hover:text-blue-900"
  >
    CC BY-SA Share Alike 3.0 Unported
  </a>
  ).
</p>

            <p className="text-lg text-gray-700 leading-relaxed">
              The Mound Trail at Blue Mounds State Park leads to breathtaking
              prairie views atop ancient Sioux quartzite cliffs. The park’s
              unique pink rock formations stand as some of the oldest exposed
              bedrock in North America.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Along the way, you’ll pass through wide-open grasslands where the
              park’s famous bison herd roams. At the summit, the landscape
              stretches endlessly — offering a panoramic view of the prairie
              ecosystem below.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              It’s a trail that captures both the geological and natural beauty
              of southwestern Minnesota — a must-hike for anyone exploring the
              region.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Trail Surface:</strong> Dirt and rock</li>
              ...
              <li><strong>Parking:</strong> Main lot near Mound Trail trailhead</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Blue Mounds State Park"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Blue Mounds State Park"
                    loading="lazy"
