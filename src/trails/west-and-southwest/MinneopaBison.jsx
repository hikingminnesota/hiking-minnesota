...
import badgePlaceholder from "../../assets/images/badge-minneopafalls.webp";
import trailheadStatic from "../../assets/images/map-swest-minneopabison.png";
import trailheadHero from "../../assets/images/Minneopa-Bison.webp";
...
const trailData = [
  ...
  { label: "Estimated Hike Duration", value: "Around 45 minutes" },
  { label: "Elevation Gain", value: "Mild terrain with hills and prairie paths" },
...
export default function MinneopaBison() {
  const addressLink =
    "https://www.google.com/maps?q=54497+Gadwall+Rd,+Mankato,+MN+56001";
  const addressText =
    "Minneopa State Park — Minneopa Falls and Bison Trail, 54497 Gadwall Rd, Mankato, MN 56001";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Minneopa State Park - Minneopa Falls and Bison Trail"
        ...
        <div className="relative text-center px-6 z-10">
          ...
          <p className="text-2xl sm:text-3xl font-medium text-lime-300 mt-4 tracking-wide">
            Minneopa Falls and Bison Trail
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Waterfalls, Bison, and Prairie Beauty
            </h3>
            <p className="text-lg text-gray-700 leading-relaxed">
  Photo of sunset at Minneopa State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:MinneopaFalls2010.jpg"
    target="_blank"
  ...
  >
    CC Attribution-Share Alike 3.0 Unported
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Minneopa State Park offers one of the most diverse hiking
              experiences in southern Minnesota. The Minneopa Falls and Bison
              Trail showcases both natural wonder and wildlife — featuring a
              dramatic double waterfall and a chance to view the park’s free-roaming
              bison herd from safe observation areas.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              The hike connects the falls area to open prairie and bison range
              sections, providing panoramic views of grasslands and sky. It’s an
              ideal blend of nature, history, and conservation in one park.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Trails are generally easy, with some rolling sections, making
              Minneopa a perfect stop for families, photographers, and wildlife
              enthusiasts alike.
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Trail Surface:</strong> Grass and dirt paths</li>
              <li><strong>Restrooms:</strong> Near falls and visitor area</li>
              <li><strong>Camping:</strong> Available in park</li>
              <li><strong>Kid Friendly?</strong> Yes</li>
              <li><strong>Pet Policy:</strong> Pets on leash</li>
              <li><strong>Parking:</strong> Falls area and bison loop trailhead</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Minneopa Falls and Bison Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Minneopa State Park"
                    loading="lazy"
