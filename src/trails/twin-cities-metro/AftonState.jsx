...
import badgePlaceholder from "../../assets/images/badge-saintcroixbluffs.webp";
import trailheadStatic from "../../assets/images/map-metro-aftonstate.png";
import trailheadHero from "../../assets/images/Afton-State-Park.webp";
...
const trailData = [
  ...
  { label: "Trail Distance", value: "4.6 miles loop" },
  { label: "Estimated Hike Duration", value: "2 - 2.5 hours" },
  { label: "Elevation Gain", value: "Approx. 860 feet (significant bluff climbs)" },
  { label: "Best Season To Visit", value: "Fall for scenic river views" },
];
...
export default function AftonState() {
  const addressLink =
    "https://www.google.com/maps?q=Afton+State+Park,+6959+Peller+Ave+S,+Hastings,+MN+55033";
  const addressText =
    "Afton State Park — St. Croix River Bluffs Trail, 6959 Peller Ave S, Hastings, MN 55033";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="Afton State Park - St. Croix River Bluffs Trail"
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Bluffs, Forest, and River Views
            </h3>
                          <p className="text-lg text-gray-700 leading-relaxed">
  Photo above of Afton State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File:Afton_State_Park_Beach.JPG"
    target="_blank"
  ...
  >
    CC BY-SA 3.0
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The St. Croix River Bluffs Trail showcases some of the Twin Cities
              Metro’s most dramatic terrain — steep climbs, wooded ridgelines,
              and breathtaking views overlooking the St. Croix River Valley.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Expect a workout on this trail, with significant elevation changes
              and narrow bluff paths that reward hikers with panoramic views at
              every turn.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Whether you’re chasing fall colors or a riverside
              retreat, Afton State Park delivers a challenge.  You will get a workout on this hike. 
            </p>
          </div>
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Restrooms:</strong> Near trailhead and beach area</li>
              <li><strong>Camping:</strong> Backpack sites and camper cabins</li>
              <li><strong>Kid Friendly?</strong> Older teens ok; steep climbs may frustrate younger children.</li>
              <li><strong>Pet Policy:</strong> Pets on leash</li>
              <li><strong>Parking:</strong> Upper and lower lots near river access</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for St. Croix River Bluffs Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Afton State Park"
                    loading="lazy"
