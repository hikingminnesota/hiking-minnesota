...
import badgePlaceholder from "../../assets/images/badge-obrienstatepark.webp";
import trailheadStatic from "../../assets/images/map-metro-riversidetrail.png";
import trailheadHero from "../../assets/images/Riverside-Trail.webp";
// 📝 Photo credit (for internal records only):
// Hero image: Photo by McGhiever via Wikimedia Commons (CC BY-SA 3.0 Unported)
...
const trailData = [
  ...
  { label: "Trail Distance", value: "1.6 miles loop" },
  { label: "Estimated Hike Duration", value: "45 minutes - 1 hour" },
  { label: "Elevation Gain", value: "Around 100 feet (mostly flat riverside path)" },
...
export default function RiversideTrail() {
  const addressLink =
    "https://www.google.com/maps?q=William+O'Brien+State+Park+Visitor+Center,+St+Croix,+MN+55047";
  const addressText =
    "William O’Brien State Park — Riverside Trail, 16821 O'Brien Trail N, Marine on St Croix, MN 55047";
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative h-[80vh] max-h-[800px] flex items-center justify-center overflow-hidden">
        <img
          src={trailheadHero}
          alt="William O'Brien State Park - Riverside Trail"
        ...
        <div className="relative text-center px-6 z-10">
          ...
          <p className="text-2xl sm:text-3xl font-medium text-lime-300 mt-4 tracking-wide">
            William O’Brien State Park — Scenic St. Croix River
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 mb-20">
          ...
          <div className="lg:w-2/3 space-y-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Peaceful Riverside Walks in the St. Croix Valley
            </h3>
  <p className="text-lg text-gray-700 leading-relaxed">
  Photo above of William O’Brien State Park is courtesy of <a
    href="https://commons.wikimedia.org/wiki/File%3AWilliam_O%27Brien_State_Park_Riverside_Trail.jpg"
    target="_blank"
  ...
  >
    CC BY-SA 3.0 Unported
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Riverside Trail at William O’Brien State Park offers a calm,
              scenic walk along the banks of the St. Croix River. This easy,
              family-friendly trail provides open views of the river and shaded
              forest paths, making it ideal for a relaxing day outdoors.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              The terrain is mostly flat with occasional boardwalks and meadow
              crossings, perfect for hikers of all ages. Expect to see songbirds,
              wildflowers, and peaceful river bends as you walk.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Whether you’re taking a short stroll or combining it with other
              trails in the park, Riverside Trail delivers tranquility just
          ...
          <aside className="lg:w-1/3 mt-10 lg:mt-0 bg-gray-800 text-white rounded-2xl shadow-2xl p-8 space-y-5">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><strong>Trail Surface:</strong> Dirt and grass path</li>
              <li><strong>Restrooms:</strong> Near main parking area</li>
              <li><strong>Camping:</strong> Available at William O’Brien State Park</li>
              <li><strong>Kid Friendly?</strong> Yes</li>
              <li><strong>Pet Policy:</strong> Pets on leash</li>
              <li><strong>Parking:</strong> Main trailhead near the visitor center</li>
              <li>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              <div className="relative w-full aspect-square overflow-hidden rounded-xl bg-gray-100">
                <img
                  ...
                  alt="Placeholder badge for Riverside Trail"
                  loading="lazy"
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 ring-1 ring-black/5">
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden rounded-xl">
                  <img
                    src={trailheadStatic}
                    alt="Trailhead map preview for Riverside Trail"
                    loading="lazy"
